...
func (c *ConcatStrategy) Write(absPath, relPath string) error {
	...
	// Add newline if missing at end of file to prevent markdown block issues
...
// minifyContent removes full-line comments and empty whitespace lines
