...
## File: codepicker_context.txt
```txt
CODEPICKER CONTEXT DUMP
=========================
FILE PATH: LICENSE
------------------------------------------------------------------------------
                                 Apache License
...
FILE PATH: internal/scanner/scanner.go
------------------------------------------------------------------------------
package scanner
import (
	"fmt"
...
FILE PATH: internal/writer/writer.go
------------------------------------------------------------------------------
package writer
import (
	"bytes"
